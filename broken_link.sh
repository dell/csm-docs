...
# Clean old logs
rm -f spider.log broken_links

# Spider mode with referrer info
wget --spider --verbose -o spider.log -e robots=off -rp --debug http://10.247.101.37:1313/csm-docs/

echo "🧹 Cleaning known false positives..."
sed -i '/http:\/\/10.247.101.37:1313\/favicons\/favicon.ico/d' spider.log
sed -i '/http:\/\/10.247.101.37:1313\/css\/prism.css/d' spider.log

echo "📄 Extracting broken links with source pages..."

awk '
# Lines like: --2025-04-15 10:01:23--  http://10.247.101.37:1313/foo/
