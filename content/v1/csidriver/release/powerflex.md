...
| If using CSM Operator with v1.13.1 and are experiencing delayed responses from the PowerFlex array greater than 1 second, this could lead to certain pods crashing. This is due to the driver not waiting for long enough before determining bad communication. | Upgrade CSM to v1.14.1 or later through CSM Operator. |
