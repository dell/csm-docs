...
5. Enable CSM Authorization in the driver installation applicable to your installation method.
  Alternatively, you can use the minimal sample files provided [here](https://github.com/dell/csm-operator/tree/release/v1.8.1/samples/minimal-samples) and install the module using default value.
