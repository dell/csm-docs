...
### Upgrading the Authorization Proxy Server
  ...
  4. Update your Storage, Role, and Tenant resource definitions with the latest [configuration](v1/concepts/authorization/v2.x/configuration/) schema. Apply changes using the Kubernetes CLI:
