...
To upgrade the driver from csi-unity {{< version-v1 key="PUnity_preVersion" >}} to csi-unity {{< version-v1 key="PUnity_latestVersion" >}}

1. Get the latest csi-unity {{< version-v1 key="PUnity_latestVersion" >}} code from Github using `git clone -b {{< version-v1 key="PUnity_latestVersion" >}} https://github.com/dell/csi-unity.git`.
