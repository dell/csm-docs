...
2. Check if the latest Helm chart version is available:
    ...
    dell/csm-authorization          {{< version-v1 key="Authv2_latestVersion" >}}          {{< version-v1 key="Authv2_latestVersion" >}}          CSM for Authorization is part of the [Container...
    ```
...
5. Update your Storage, Role, and Tenant resource definitions with the latest [configuration](v1/concepts/authorization/v2.x/configuration/) schema. Apply changes using the Kubernetes CLI:
