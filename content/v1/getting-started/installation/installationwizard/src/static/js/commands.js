...
const powermaxCredNote = 'The CSI PowerMax Reverse Proxy ConfigMap will not be supported after CSM 1.14 (May 2025) and will be fully deprecated by CSM 1.16 (January 2026). Please switch to using the CSI PowerMax secret before these dates to avoid disruptions. Migration steps are available for both <a href="/csm-docs/v1/getting-started/upgrade/kubernetes/powermax/helm/" target="_blank" rel="noopener noreferrer">Helm</a> and <a href="/csm-docs/v1/getting-started/upgrade/kubernetes/powermax/operator/" target="_blank" rel="noopener noreferrer">Operator</a>.'
