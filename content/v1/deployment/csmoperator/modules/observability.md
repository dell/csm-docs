...
- Enable Observability module and components in [sample manifests](https://github.com/dell/csm-operator/tree/release/v1.8.1/samples). If cert-manager has already been installed, don't enable it.
...
Alternatively, you can use the minimal sample files provided
  [here](https://github.com/dell/csm-operator/tree/release/v1.8.1/samples/minimal-samples).
