...
{{% cardpane %}}
  ...
  Container Storage Module Operator is a Kubernetes Operator, which can be used to install and manage the CSI Drivers and CSM Modules provided by Dell for various storage platforms. This operator is available as a community operator for upstream Kubernetes and can be deployed using OperatorHub.io. The operator can be installed using OLM (Operator Lifecycle Manager) or manually.
...
{{% cardpane %}}
  {{< card header="[CSI Drivers Installation via Helm](helm/drivers)"
   ...
   CSI Helm installer installs the CSI Driver components using the provided Helm charts.
  ...
  {{< /card >}}
   {{< card header="[CSI Drivers Installation via offline installer](offline/)"
  ...
  Both Helm and Container Storage Module operator supports offline installation of the Dell CSI Storage Providers via `csi-offline-bundle.sh` or `csm-offline-bundle.sh` script, respectively, by creating a usable package.
   [...More on installation instructions](offline/drivers)
  {{< /card >}}
{{% /cardpane %}}
{{% cardpane %}}
  {{< card header="[Container Storage Module for Observability](helm/modules/installation/observability/)"
  ...
  {{< /card >}}
   {{< card header="[Container Storage Module for Authorization](helm/modules/installation/authorization-v2.0/)"
          footer="Installs Authorization Module">}}
  Authorization can be installed by using the provided Helm v3 charts on Kubernetes platforms or Container Storage Module operator.
  [...More on installation instructions](helm/modules/installation/authorization-v2.0/)
  {{< /card >}}
{{% /cardpane %}}
{{% cardpane %}}
  {{< card header="[Container Storage Module for Resiliency](helm/modules/installation/resiliency)"
  ...
  {{< /card >}}
   {{< card header="[Container Storage Module for Replication](helm/modules/installation/replication)"
