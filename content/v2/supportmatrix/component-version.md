...
| Component | Version |
| - | - |
|<div style="text-align:left"> PowerFlex | {{< version-v2 key="csi-vxflexos" >}} |
|<div style="text-align:left"> PowerStore | {{< version-v2 key="csi-powerstore" >}} |
|<div style="text-align:left"> PowerMax | {{< version-v2 key="csi-powermax" >}} |
|<div style="text-align:left"> PowerScale | {{< version-v2 key="csi-powerscale" >}} |
|<div style="text-align:left"> Unity XT | {{< version-v2 key="csi-powerscale" >}} |
|<div style="text-align:left"> Authorization v1.x | {{< version-v2 key="csm-authorization-v1" >}} |
|<div style="text-align:left"> Authorization v2.x |{{< version-v2 key="csm-authorization-v2" >}} |
|<div style="text-align:left"> Observability | {{< version-v2 key="csm-observability" >}} |
|<div style="text-align:left"> Replication |{{< version-v2 key="csm-replication" >}} |
|<div style="text-align:left"> Resiliency | {{< version-v2 key="karavi-resiliency" >}} |
| Application Mobility |{{< version-v2 key="csm-applicationmobility" >}} |
{{</table>}}
</ul>
<br>
