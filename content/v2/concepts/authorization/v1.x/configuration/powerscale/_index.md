...
Given a setup where Kubernetes, a storage system, and Container Storage Modules for Authorization Proxy Server are deployed, follow these steps to configure the CSI Drivers to work with the Authorization sidecar:
...
5. Enable Container Storage Modules Authorization in the driver installation applicable to your installation method.
   ...
   Example:
    ...
    authorization:
      ...
      sidecarProxyImage: quay.io/dell/container-storage-modules/csm-authorization-sidecar:{{< version-v2 key="Authv1_csm_authorization_sidecar" >}}
    ...
    **Operator**
    ...
    - Update the `PROXY_HOST` environment value to the hostname of Authorization Proxy Server. `csm-authorization.com` is a placeholder for the proxyHost. See the administrator of for Authorization for the correct value.
    ...
    modules:
      ...
      - name: authorization
        ...
        - name: karavi-authorization-proxy
          image: quay.io/dell/container-storage-modules/csm-authorization-sidecar:{{< version-v2 key="Authv1_csm_authorization_sidecar" >}}
          envs:
            # proxyHost: hostname of the csm-authorization server
            - name: "PROXY_HOST"
    ...
    [here](https://github.com/dell/csm-operator/tree/release/{{< version-v2 key="csm-operator_latest_version" >}}/samples/minimal-samples/powerscale_{{< version-v2 key="Min_sample_operator_pstore" >}}.yaml) and install the module using default values
