...
Steps for performing Failover can be found in the Tools page under [Executing Actions.](v2/tooling/repctl/#executing-actions) There are some PowerScale-specific considerations to keep in mind: 
