...
3. ##### **Create Custom Resource** ContainerStorageModule for powerflex.
    ...
    **Detailed Configuration:** Use the [sample file](https://github.com/dell/csm-operator/tree/release/{{< version-v2 key="csm-operator_latest_version" >}}/samples/storage_csm_powerflex_{{< version-v2 key="Det_sample_operator_pflex" >}}.yaml) for detailed settings.
...
vxflexos    3h             powerflex       {{< version-v2 key="PFlex_latestVersion" >}}         Succeeded
```
