...
3. ##### **Create Custom Resource** ContainerStorageModule for powerflex.
    ...
    **Detailed Configuration:** Use the [sample file](https://github.com/dell/csm-operator/blob/main/samples/storage_csm_powerflex_{{< version-v2 key="Det_sample_operator_pflex" >}}.yaml) for detailed settings.
