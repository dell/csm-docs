...
<br>
{{<include  file="content/v2/getting-started/installation/openshift/powerstore/prerequisite/_index.md" >}}
...
3. ##### **Create Custom Resource** ContainerStorageModule for powerstore.
    ...
    **Detailed Configuration:** Use the [sample file](https://github.com/dell/csm-operator/blob/main/samples/storage_csm_powerstore_{{< version-v2 key="sample_sc_pstore" >}}.yaml) for detailed settings or use [Wizard](./installationwizard#generate-manifest-file) to generate the sample file.
...
powerstore  3h             powerstore      {{< version-v2 key="PStore_latestVersion" >}}               Succeed
```
