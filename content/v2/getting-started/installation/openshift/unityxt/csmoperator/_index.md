...
3. ##### **Create Custom Resource** ContainerStorageModule for unity.
    ...
    **Detailed Configuration:** Use the [sample file](https://github.com/dell/csm-operator/blob/main/samples/storage_csm_unity_{{< version-v2 key="sample_sc_unity" >}}.yaml) for detailed settings.
