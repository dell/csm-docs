...
<br>
{{<include  file="content/v2/getting-started/installation/openshift/unityxt/prerequisite/_index.md" >}}
...
3. ##### **Create Custom Resource** ContainerStorageModule for unity.
   ...
   <br>
    ...
    spec:
      driver:
        csiDriverType: "unity"
        configVersion: {{< version-v2 key="PUnity_latestVersion" >}}
        forceRemoveDriver: true
    EOF 
    ``` 
    </div>

    **Detailed Configuration:** Use the [sample file](https://github.com/dell/csm-operator/tree/release/{{< version-v2 key="csm-operator_latest_version" >}}/samples/storage_csm_unity_{{< version-v2 key="sample_sc_unity" >}}.yaml) for detailed settings.
...
unity       3h             unity           {{< version-v2 key="PUnity_latestVersion" >}}             Succeeded      
```
