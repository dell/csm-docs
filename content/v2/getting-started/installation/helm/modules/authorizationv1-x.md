...
| authorization.images.proxyService                 | The image to use for the proxy-service.                                                                                      | Yes      | quay.io/dell/container-storage-modules/csm-authorization-proxy:{{< version-v2 key="Authv1_csm_authorization_proxy" >}}   |
| authorization.images.tenantService                | The image to use for the tenant-service.                                                                                     | Yes      | quay.io/dell/container-storage-modules/csm-authorization-tenant:{{< version-v2 key="Authv1_csm_authorization_tenant" >}}  |
| authorization.images.roleService                  | The image to use for the role-service.                                                                                       | Yes      | quay.io/dell/container-storage-modules/csm-authorization-proxy:{{< version-v2 key="Authv1_csm_authorization_role" >}}   |
| authorization.images.storageService               | The image to use for the storage-service.                                                                                    | Yes      | quay.io/dell/container-storage-modules/csm-authorization-storage:{{< version-v2 key="Authv1_csm_authorization_storage" >}} |
...
Karavictl commands and intended use can be found [here](v2/concepts/authorization/v1.x/cli/). 
...
Please continue following the steps outlined in the [proxy server](v2/concepts/authorization/v1.x/configuration/proxy-server) configuration.

## Configuring a Dell CSI Driver with Container Storage Modules for Authorization

The second part of Authorization deployment is to configure one or more of the [supported](v2/concepts/authorization#supported-csi-drivers) CSI drivers. This is controlled by the Kubernetes tenant admin.

Please continue following the configuration steps for a specific CSI Driver [here](v2/concepts/authorization/v1.x/configuration/).
