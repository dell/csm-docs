...
{{< accordion id="One" title="CSM Installation Wizard" >}}
            {{<include  file="content/v2/getting-started/installation/installationwizard/helm.md" Var="powerscale" hideIds="2">}}
{{< /accordion >}}
<br>
...
1. Run `git clone -b {{< version-v2 key="PScale_latestVersion" >}} https://github.com/dell/csi-powerscale.git` to clone the git repository.
