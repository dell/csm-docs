...
Enable the SDC monitor by setting the `enable` flag to `true`.
   ...
   Example CR: [samples/storage_csm_powerflex_{{< version-v2 key="sample_sc_pflex" >}}.yaml](https://github.com/dell/csm-operator/tree/release/{{< version-v2 key="csm-operator_latest_version" >}}/samples/storage_csm_powerflex_{{< version-v2 key="sample_sc_pflex" >}}.yaml)
...
3. **Install driver:**
   ...
   i. **Create a CR (Custom Resource)** for PowerFlex using the sample files provided
    ...
    ```
     Refer the [sample file](https://github.com/dell/csm-operator/tree/release/{{< version-v2 key="csm-operator_latest_version" >}}/samples/minimal-samples/powerflex_{{< version-v2 key="sample_sc_pflex" >}}.yaml). Modify if needed.

    [OR]

    b. **Detailed Configuration:** Use the [sample file](https://github.com/dell/csm-operator/tree/release/{{< version-v2 key="csm-operator_latest_version" >}}/samples/storage_csm_powerflex_{{< version-v2 key="sample_sc_pflex" >}}.yaml) for detailed settings.
