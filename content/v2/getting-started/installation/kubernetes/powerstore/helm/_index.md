...
{{< accordion id="One" title="CSM Installation Wizard" >}}
    {{<include  file="content/v2/getting-started/installation/installationwizard/helm.md" Var="powerstore" hideIds="2,4">}}
{{< /accordion >}}
...
**Steps**
1. Run `git clone -b {{< version-v2 key="PStore_latestVersion" >}} https://github.com/dell/csi-powerstore.git` to clone the git repository.
