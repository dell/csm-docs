...
5. **Install Driver**
    ...
    a. **Default Configuration:** Use the [sample file](https://github.com/dell/csm-operator/tree/release/{{< version-v2 key="csm-operator_latest_version" >}}/samples/minimal-samples/powermax_{{< version-v2 key="Min_sample_operator_pmax" >}}.yaml) for default settings. Modify if needed.
