...
>For more information on upgrading the CSI driver, please visit the [CSI driver upgrade page](v2/getting-started/upgrade/kubernetes).
...
> _**Note**_: These steps assume that you already have `repctl` configured to use correct clusters, if you don't know how to do that please refer to [installing with repctl](v2/getting-started/installation/helm/modules/replication/install-repctl)
