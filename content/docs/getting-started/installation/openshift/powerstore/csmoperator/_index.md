...
3. ##### **Create Custom Resource** ContainerStorageModule for powerstore.
    ...
    **Detailed Configuration:** Use the [sample file](https://github.com/dell/csm-operator/tree/release/v1.9.1/samples/storage_csm_powerstore_{{< version-docs key="sample_sc_pstore" >}}.yaml) for detailed settings or use [Wizard](./installationwizard#generate-manifest-file) to generate the sample file.
