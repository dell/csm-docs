...
3. ##### **Create Custom Resource** ContainerStorageModule for unity.
    ...
    **Detailed Configuration:** Use the [sample file](https://github.com/dell/csm-operator/blob/main/samples/{{< version-docs key="csm-operator_latest_samples_dir" >}}/storage_csm_unity_{{< version-docs key="sample_sc_unity" >}}.yaml) for detailed settings.
