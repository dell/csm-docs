...
function setValues(csmMapValues, CONSTANTS_PARAM) {
	...
	DriverValues.multiNasFailureThreashold = document.getElementById("multi-nas-failure-threshold").value;
...
function createYamlString(yamlTpl, yamlTplValues, driverParam, CONSTANTS_PARAM) {
	...
	yamlTpl = yamlTpl.replaceAll("$MULTI_NAS_FAILURE_THRESHOLD", yamlTplValues.multiNasFailureThreashold);
