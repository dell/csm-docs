...
const approveSdcNote = 'If approve SDC is not enabled, ensure to approve the SDC manually before provisioning';
...
const powermaxCredNote = 'The CSI PowerMax Reverse Proxy ConfigMap will no longer be supported as of CSM 1.14 (May 2025) and completely deprecated on CSM 1.16 (January 2026). Please switch to using the CSI PowerMax Mount Credentials before these dates to prevent any potential disruptions. Migration steps are available for both <a href="/csm-docs/docs/getting-started/upgrade/kubernetes/powermax/helm/" target="_blank" rel="noopener noreferrer">Helm</a> and <a href="/csm-docs/docs/getting-started/upgrade/kubernetes/powermax/operator/" target="_blank" rel="noopener noreferrer">Operator</a>.'
