...
| authorization.images.proxyService                 | The image to use for the proxy-service.                                                                                      | Yes      | quay.io/dell/container-storage-modules/csm-authorization-proxy:{{< version-docs key="Authv1_csm_authorization_proxy" >}}   |
| authorization.images.tenantService                | The image to use for the tenant-service.                                                                                     | Yes      | quay.io/dell/container-storage-modules/csm-authorization-tenant:{{< version-docs key="Authv1_csm_authorization_tenant" >}}  |
| authorization.images.roleService                  | The image to use for the role-service.                                                                                       | Yes      | quay.io/dell/container-storage-modules/csm-authorization-proxy:{{< version-docs key="Authv1_csm_authorization_role" >}}   |
| authorization.images.storageService               | The image to use for the storage-service.                                                                                    | Yes      | quay.io/dell/container-storage-modules/csm-authorization-storage:{{< version-docs key="Authv1_csm_authorization_storage" >}} |
