...
1. Create a CR (Custom Resource) for PowerFlex using the sample files provided
    ...
    a. **Default Configuration:** Use the [sample file](https://github.com/dell/csm-operator/tree/release/v1.9.1/samples/minimal-samples/unity_{{< version-docs key="Min_sample_operator_unity" >}}.yaml) for default settings. Modify if needed.

    [OR]                                                

    b. **Detailed Configuration:** Use the [sample file](https://github.com/dell/csm-operator/tree/release/v1.9.1/samples/storage_csm_unity_{{< version-docs key="Det_sample_operator_unity" >}}.yaml) for detailed settings.
