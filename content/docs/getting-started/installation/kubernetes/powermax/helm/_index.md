...
| transportProtocol  | Set the preferred transport protocol for the Kubernetes cluster which helps the driver to choose which transport protocol to use (ISCSI, FC, NVMETCP or "") defaults to auto if nothing is specified.                                                                                                                                                                                | Yes | ""|
