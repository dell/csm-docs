...
|<div style="text-align: left"> blockProtocol |<div style="text-align: left"> Defines the block protocol to use. Allowed values: `auto`, `SDC` and `NVMeTCP`. | false | auto |
...
|<div style="text-align: left"> authType |<div style="text-align: left"> Specify the Authentication type between BasicAuth and OIDC. | No | "" |
...
|<div style="text-align: left"> enabled |<div style="text-align: left"> A boolean that enables/disables installation of the SDC. Set to `false` if using NVMe/TCP. | No | true |
