...
{{<includee  file="content/docs/getting-started/installation/offline/operator.md" suffix="1">}}

{{< /accordion >}}
<br> 
{{< accordion id="Two" title="Helm" markdown="true" >}} 
{{<includee  file="content/docs/getting-started/installation/offline/helm.md" suffix="2">}}
