...
<img src="/beta-csm-docs/images/deployment/uninstall.JPG" width="2500px"  style="border: 2px solid #ccc; padding: 10px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
