...
## Update Driver from {{< version-docs key="PFlex_preVersion" >}} to {{< version-docs key="csi_powerflex_latest_version" >}} using Helm

**Steps**
1. Run `git clone -b {{< version-docs key="csi_powerflex_latest_version" >}} https://github.com/dell/csi-powerflex.git` to clone the git repository and get the {{< version-docs key="csi_powerflex_latest_version" >}} driver.
