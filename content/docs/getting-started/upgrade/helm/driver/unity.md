...
To upgrade the driver from csi-unity {{< version-docs key="PUnity_preVersion" >}} to csi-unity {{< version-docs key="csi_unity_latest_version" >}}

1. Get the latest csi-unity {{< version-docs key="csi_unity_latest_version" >}} code from Github using `git clone -b {{< version-docs key="csi_unity_latest_version" >}} https://github.com/dell/csi-unity.git`.
