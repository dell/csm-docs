...
* Tagging and pushing images
   ...
   dellemc/csi-powerstore:v2.9.0 -> localregistry:5000/csi-operator/csi-powerstore:v2.9.0
...
* Preparing operator files within /root/dell-csi-operator-bundle
   ...
   changing: dellemc/csi-powerstore:v2.9.0 -> localregistry:5000/csi-operator/csi-powerstore:v2.9.0
