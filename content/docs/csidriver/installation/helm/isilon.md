...
5. Edit *my-isilon-settings.yaml* to set the following parameters for your installation:
   ...
   | isiAuthType | Indicates whether the authentication will be session-based or basic. If set to 1 then it follows as session-based authentication else basic authentication | No | 0 |
