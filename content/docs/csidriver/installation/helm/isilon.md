...
4. Download  `wget -O my-isilon-settings.yaml https://raw.githubusercontent.com/dell/helm-charts/main/charts/csi-isilon/values.yaml` into  `cd ../dell-csi-helm-installer` with name say *my-isilon-settings.yaml* , to customize settings for installation.
