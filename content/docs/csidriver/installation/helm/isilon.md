...
5. Edit *my-isilon-settings.yaml* to set the following parameters for your installation:
   ...
   *NOTE:*
   ...
   - If you are using a custom images, update each attributes under the *images* field in *my-isilon-setting.yaml* to make sure that they are pointing to the correct image repository.
