...
Starting from v2.7.0 , these secrets will be created automatically using the below tls.key and tls.cert contents provided in my-powermax-settings.yaml file.
