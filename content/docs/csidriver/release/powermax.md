...
| [Automatic SRDF group creation is failing with "Unable to get Remote Port on SAN for Auto SRDF" for PowerMaxOS 10.1 arrays](https://github.com/dell/csm/issues/1071) | Create the SRDF Group and add it to the storage class |
### Note:
