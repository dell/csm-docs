...
| Retagging of the 2.3.0 driver image to fix dirty tag will cause issue with the certified operator functionality .So if the driver controller logs shows "VendorVersion=2.3.0+dirty"           | Update driver to 2.4.0  version                                                                                                                                                                                                                                                      |
