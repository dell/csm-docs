...
> _**NOTE**_: To delete the last PV from a SYNC Replication Group in PowerStore, the user needs to first unassign the protection policy from the corresponding  on the PowerStore Manager UI. For more details, please refer to the troubleshooting section.
