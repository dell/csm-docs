...
## Configuring PowerScale CSI Driver with Container Storage Module for Authorization

Given a setup where Kubernetes, a storage system, and Container Storage Module for Authorization Proxy Server are deployed, follow these steps to configure the CSI Drivers to work with the Authorization sidecar:
