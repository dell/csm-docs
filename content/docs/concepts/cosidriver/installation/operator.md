...
2. Create a new file called `secret.yaml` with the contents of the [configuration file](../configuration_file#configuration-file-example). Edit the file with parameters specific to the ObjectScale instance.
