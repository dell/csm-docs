...
| Issue | Workaround |
|-------|------------|
| <div style="text-align: left"> Installation of CSM Operator 1.10.0 from the OpenShift Web Console results in the Operator instance being stuck in the state upgradePending. |  <div style="text-align: left"> Uninstall the Operator that is stuck and reinstall. |
