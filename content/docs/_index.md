...
Please be advised the Dell CSM Operator will undergo planned maintenance on Thursday, 4/18/2024 from [start time] to [end time] (UTC) (approximately [XYZ] hours). During this period, the following Dell CSM Operator versions will be unavailable for new installations and upgrades:
