...
| Version     | Capability                                                                                            | PowerStore | PowerScale | PowerFlex | PowerMax | Unity XT |
|-------------|-------------------------------------------------------------------------------------------------------| :--------: | :--------: | :-------: | :------: | :------: |
| K8s - 1.35(KubeVirt 1.7)  | <div style="text-align: left"> [Storage](https://github.com/coulof/kubevirt-storage-checkup/tree/feature/multi-platform-support) </div>| Yes | No   | Yes   | Yes  | No   |
| K8s - 1.34(KubeVirt 1.7)  | <div style="text-align: left"> [Storage](https://github.com/coulof/kubevirt-storage-checkup/tree/feature/multi-platform-support) </div>| Yes | No   | Yes  | Yes  | No   |
| K8s - 1.33(KubeVirt 1.6)  | <div style="text-align: left"> [Storage](https://github.com/coulof/kubevirt-storage-checkup/tree/feature/multi-platform-support) </div>| Yes | No   | Yes  | Yes  | No   |
{{</table>}}
