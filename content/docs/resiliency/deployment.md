...
| ignoreVolumelessPods | Optional | Boolean value that if set to true will enable CSM for Resiliency to ignore volumeless pods even if those are labeled. | controller & node |
