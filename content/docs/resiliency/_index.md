...
* Multi-array are supported. Incase of CSI Driver PowerScale and CSI Driver Unity, if any one of the array is not connected, the array connectivity will be false. For CSI Driver Powerflex connectivity will be determined by connection to default array.
