...
* Multi-array are supported. Incase of CSI Driver PowerScale and CSI Driver Unity, if any one of the array is not connected, the array connectivity will be false.
