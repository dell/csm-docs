...
* Multi-array are supported. Incase of CSI Driver PowerSale and CSI Driver Unity, if any one of the array is not connected, the array connectivity will be false.
