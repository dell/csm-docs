...
---
<hr>
{{< include "content/docs/support/release/csminstallationwizard.md" >}}

<hr>
{{< include "content/docs/support/release/csmoperator.md" >}}
<hr>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    tabButtons.forEach(button => {
      button.addEventListener('click', function() {
        ...
        contentContainer.innerHTML = contentMap[contentId];
      });
    });
