...
Example: karavictl generate token --admin-token admintoken.yaml | kubectl apply -f -
...
```
$ karavictl generate token --shared-secret supersecret --admin-token admintoken.yaml
