...
| To add or delete volumes in the existing SYNC Replication Group in PowerStore, user need to pause the replication group, add the volume and then resume replication groups(RG). Commands for pause and resume operation is:
` ` 
` `
