...
| To add or delete volumes in the existing replication group(RG), user need to pause the replication, add the volume and the resume replication groups(RG). Commands for pause and resume operation is:
` ` 
` `
