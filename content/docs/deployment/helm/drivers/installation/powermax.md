...
Depending of your Kubernetes distribution or the level of security you have there are several pre-requisites that must be met before you can install the CSI Driver.

#### (Optional) Certificate validation for Unisphere REST API calls
