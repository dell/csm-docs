...
The second part of CSM for Authorization deployment is to configure one or more of the [supported](../../_index.md#supported-csi-drivers) CSI drivers. This is controlled by the Kubernetes tenant admin.
