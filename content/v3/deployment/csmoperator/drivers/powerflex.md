...
- For non-supported versions of the OS also do the manual SDC deployment steps given below. Refer to https://quay.io/repository/dell/storage/powerflex/sdc for supported versions.
...
##### Example CR:  [samples/storage_csm_powerflex_v2120.yaml](https://github.com/dell/csm-operator/tree/release-v1.7.0/samples/storage_csm_powerflex_v2120.yaml)
```yaml
    sideCars:
    # sdc-monitor is disabled by default, due to high CPU usage
      - name: sdc-monitor
        enabled: false
        image: quay.io/dell/storage/powerflex/sdc:4.5
        envs:
        - name: HOST_PID
          value: "1"
        - name: MDM
