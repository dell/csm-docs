...
##### Example CR:  [samples/storage_csm_powerflex_v2131.yaml](https://github.com/dell/csm-operator/tree/release/{{< version-v3 key="csm-operator_latest_version" >}}/samples/storage_csm_powerflex_v2131.yaml)
